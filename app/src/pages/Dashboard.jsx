  ...
  return (
    <div style={{ maxWidth: 1152, margin: '0 auto' }}>
      <motion.div
        ...
        <h1 style={{ fontSize: '2.25rem', fontWeight: 700, color: '#111827', marginBottom: '0.5rem' }}>Good morning, Jakob! 🍳</h1>
      ...
      <motion.div
        ...
        <motion.button
          ...
          <p style={{ opacity: 0.8 }}>Generate a new weekly meal plan in seconds.</p>
        </motion.button>
        ...
        <motion.button
          ...
          onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#d66229'}
          onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#e8723a'}>
          ...
          <p style={{ opacity: 0.8 }}>Browse curated recipes and fresh ideas.</p>
        </motion.button>
        ...
        <motion.button
          ...
          <p style={{ opacity: 0.8 }}>Save money with this week's Mercator discounts.</p>
        </motion.button>
      </motion.div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '2rem' }}>
        <div>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '1.5rem' }}>
            <h2 style={{ fontSize: '1.5rem', fontWeight: 700, color: '#111827' }}>Today's Menu</h2>
            {currentPlan &&
            <button
              onClick={() => navigate('/planner')}
              style={{ color: '#e8723a', fontWeight: 500, display: 'flex', alignItems: 'center', gap: '0.25rem', background: 'none', border: 'none', cursor: 'pointer' }}>
          ...
          <div style={{ backgroundColor: 'white', borderRadius: '1.5rem', padding: '1.5rem', boxShadow: '0 1px 2px rgb(0 0 0 / 0.05)', border: '1px solid #f3f4f6', display: 'flex', gap: '1.5rem' }}>
            ...
            <div key={mealType} style={{ flex: 1 }}>
                  ...
                  <div style={{ backgroundColor: '#faf8f5', borderRadius: '1rem', padding: '1rem', display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    ...
                    <div>
                      <h4 style={{ fontWeight: 700, color: '#1f2937', lineHeight: 1.25 }}>{todayMeals[mealType].name}</h4>
          ...
          <div style={{ backgroundColor: 'white', borderRadius: '1.5rem', padding: '2.5rem', boxShadow: '0 1px 2px rgb(0 0 0 / 0.05)', border: '2px dashed #d1d5db', textAlign: 'center' }}>
              ...
              <h3 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#1f2937', marginBottom: '0.5rem' }}>No plan for today</h3>
              <p style={{ color: '#6b7280', marginBottom: '1.5rem' }}>Generate a meal plan to see your daily menu here.</p>
              <button
              onClick={() => navigate('/planner')}
              style={{ backgroundColor: '#4a6741', color: 'white', padding: '0.5rem 1.5rem', borderRadius: '0.75rem', fontWeight: 500, border: 'none', cursor: 'pointer' }}>
        ...
        <div>
          <h2 style={{ fontSize: '1.5rem', fontWeight: 700, color: '#111827', marginBottom: '1.5rem' }}>Your Stats</h2>
          <div style={{ backgroundColor: 'white', borderRadius: '1.5rem', padding: '1.5rem', boxShadow: '0 1px 2px rgb(0 0 0 / 0.05)', border: '1px solid #f3f4f6' }}>
            <div style={{ marginBottom: '1.5rem' }}>
              <p style={{ fontSize: '0.875rem', color: '#6b7280', marginBottom: '0.25rem' }}>Plans Created</p>
              <p style={{ fontSize: '1.875rem', fontWeight: 700, color: '#111827' }}>{mealHistory.length}</p>
            </div>
            ...
            <div>
              ...
              <p style={{ fontSize: '1.25rem', fontWeight: 700, color: '#111827', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                🍝 Italian
              </p>
            </div>
          </div>
